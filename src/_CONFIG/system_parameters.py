...
ESQUEMA: list[dict] = [
    ...
    },
    {
        ...
        "categoria": "MODO",
        "descricao": "Mínimo de observações antes de uma bola poder ser considerada parada",
        "unidade":   "frames",
        "default":   3,
        "tipo":      "int",
        "min":       1,
    ...
    },
    {
        ...
        "categoria": "MODO",
        "descricao": "Tempo mínimo observado para confirmar uma bola parada",
        "unidade":   "s",
        "default":   1.0,
        "tipo":      "float",
        "min":       0.1,
    ...
    },
    {
        ...
        "categoria": "MODO",
        "descricao": "Tempo sem observação antes de remover uma bola temporária",
        "unidade":   "s",
        "default":   1.5,
        "tipo":      "float",
        "min":       0.2,
    ...
    },
    {
        ...
        "categoria": "PERFORMANCE",
        "descricao": "Guardar frames e top-down por ciclo (0=desligado, 1=ligado; requer guardar_resultados_disco=1)",
        "unidade":   "",
        "default":   0,
        "tipo":      "int",
        "min":       0,
