...
Revê `src/resultados/configuracao/parametros.json` a partir da raiz do repositório
(ou `resultados/configuracao/parametros.json` se já estiveres dentro de `src`):
...
Abre `src/_ROBOT/robo_coletor_esp32/robo_coletor_esp32.ino` no Arduino IDE.
